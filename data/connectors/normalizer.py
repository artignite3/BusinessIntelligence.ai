"""Enterprise column schema normalizer for real-world portal and warehouse data."""
...
SALES_COLUMN_MAP: Dict[str, str] = {
    ...
    "OrderVolume": "orders_count",
    "total_orders": "orders_count",
    "GrossRevenue": "gross_amount",
    "gross_sales": "gross_amount",
    "DiscountAmount": "discounts",
    "disc_amount": "discounts",
    "RefundTotal": "returns_refund",
    "refunds": "returns_refund",
    "COGS": "margin_cost",
    "cogs_amount": "margin_cost",
...
LOGISTICS_COLUMN_MAP: Dict[str, str] = {
    ...
    "Date": "date",
    "Territory": "region",
    "CarrierName": "primary_carrier",
    "carrier": "primary_carrier",
    "DispatchDelayHours": "avg_dispatch_delay_hours",
    "dispatch_delay": "avg_dispatch_delay_hours",
    "OTIFScore": "otif_percentage",
    "otif_rate": "otif_percentage",
    "TransitDamageEvents": "transit_damage_claims",
    "damage_claims": "transit_damage_claims",
